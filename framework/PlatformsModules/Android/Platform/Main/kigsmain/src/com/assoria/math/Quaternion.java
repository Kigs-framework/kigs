...
public class Quaternion extends Vector4f {
    ...
    private static Vector4f tmpVec4 = new Vector4f();
    /**
    ...
    public void multiplyByQuat(Quaternion input, Quaternion output) {
        if (input != output) {
            ...
            tmpVec4.points[0] = input.points[0];
            tmpVec4.points[1] = input.points[1];
            tmpVec4.points[2] = input.points[2];
            tmpVec4.points[3] = input.points[3];

            output.points[3] = (points[3] * tmpVec4.points[3] - points[0] * tmpVec4.points[0] - points[1]
                    * tmpVec4.points[1] - points[2] * tmpVec4.points[2]); //w = w1w2 - x1x2 - y1y2 - z1z2
            output.points[0] = (points[3] * tmpVec4.points[0] + points[0] * tmpVec4.points[3] + points[1]
                    * tmpVec4.points[2] - points[2] * tmpVec4.points[1]); //x = w1x2 + x1w2 + y1z2 - z1y2
            output.points[1] = (points[3] * tmpVec4.points[1] + points[1] * tmpVec4.points[3] + points[2]
                    * tmpVec4.points[0] - points[0] * tmpVec4.points[2]); //y = w1y2 + y1w2 + z1x2 - x1z2
            output.points[2] = (points[3] * tmpVec4.points[2] + points[2] * tmpVec4.points[3] + points[0]
                    * tmpVec4.points[1] - points[1] * tmpVec4.points[0]); //z = w1z2 + z1w2 + x1y2 - y1x2
        }
    }
    ...
    public void slerp(Quaternion input, Quaternion output, float t) {
        ...
        // use output as tmp quaternion
        if (cosHalftheta < 0) {
            cosHalftheta = -cosHalftheta;
            output.points[0] = (-input.points[0]);
            output.points[1] = (-input.points[1]);
            output.points[2] = (-input.points[2]);
            output.points[3] = (-input.points[3]);
        } else {
            output = input;
        }
        ...
        if (Math.abs(cosHalftheta) >= 1.0) {
            ...
            output.points[0] = ((float) (this.points[0] * ratioA + output.points[0] * ratioB));
            output.points[1] = ((float) (this.points[1] * ratioA + output.points[1] * ratioB));
            output.points[2] = ((float) (this.points[2] * ratioA + output.points[2] * ratioB));
            output.points[3] = ((float) (this.points[3] * ratioA + output.points[3] * ratioB));
        }
    }
}
