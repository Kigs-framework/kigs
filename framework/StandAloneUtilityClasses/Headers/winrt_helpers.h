...
namespace Kigs
{
	namespace Utils
	{
		...
		inline concurrency::task<SmartPointer<Kigs::File::FileHandle>> MakeHandleFromStorageFile(winrt::Windows::Storage::StorageFile file)
		{
			SmartPointer<Kigs::File::FileHandle> result;
			auto name = file.Name();
		...
		inline SmartPointer<Kigs::File::FileHandle> MakeHandleFromStorageFileNoCopy(winrt::Windows::Storage::StorageFile file)
		{
			SmartPointer<Kigs::File::FileHandle> result;
