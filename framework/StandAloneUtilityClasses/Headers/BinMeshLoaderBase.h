	...
	namespace Utils
	{
		...
		public:
			...
			public:
				 ...
				 */
				static void	ReadStruct(BinFileStruct* result, File::BufferedFile* file, BinFileStructDesc* desc = 0);
		...
		protected:
			 ...
			 */
			std::string	ReadString(File::BufferedFile*);
			 ...
			 */
			void			ReadFloatArray(float* dst, unsigned int count, File::BufferedFile* file);
