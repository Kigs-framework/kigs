	...
	namespace Utils
	{
		...
		*/
		...
		protected:
			...
			SP<Kigs::Draw::ModernMeshItemGroup>	readBinData(unsigned char* binData, Kigs::Draw::ModernMesh*);
			SP<Kigs::Draw::ModernMeshItemGroup>	readAsciiData(AsciiParserUtils& asciiData, Kigs::Draw::ModernMesh*);
