...
public:
	...
	const std::map<std::string, std::vector<std::string>>& GetBundleList() { return myBundleList; }
...
protected:
	...
	std::map<std::string,std::vector<std::string> >		myPath;	
	...
	std::map<std::string, std::vector<std::string> >	myBundleList;
