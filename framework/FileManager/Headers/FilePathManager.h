	...
	namespace File
	{
		...
		*/
		...
		public:
			...
			const unordered_map<std::string, std::vector<std::string>>& GetBundleList() { return mBundleList; }
		...
		protected:
			...
			unordered_map<std::string, std::vector<std::string> >		mPath;
			...
			unordered_map<std::string, std::vector<std::string>> mBundleList;
			...
			unordered_map<KigsID, std::string>	mExtensionAlias;
