...
namespace Kigs
{
	namespace Draw
	{
		...
		public:
			...
			virtual void DrawUIQuad(TravState* state, const Draw2D::UIVerticesInfo* qi) override;
			virtual void DrawUITriangles(TravState* state, const Draw2D::UIVerticesInfo* qi) override;
