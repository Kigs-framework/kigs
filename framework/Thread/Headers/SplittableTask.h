...
namespace Kigs
{
	namespace Thread
	{
		...
		protected:
			...
			bool									mWaitFinish = true;
			bool									mIsSplittable = false;
			u32										mSplitCount = 0;
			std::weak_ptr<CoreModifiable>			mThreadPoolManager;

			WRAP_ATTRIBUTES(mWaitFinish, mIsSplittable, mSplitCount, mThreadPoolManager);
