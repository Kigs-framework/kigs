...
IMPLEMENT_CLASS_INFO(SemaphoreWUP)


SemaphoreWUP::SemaphoreWUP(const kstl::string& name,CLASS_NAME_TREE_ARG) : Semaphore(name,PASS_CLASS_NAME_TREE_ARG)
{
	myHandle=0;
...
bool	SemaphoreWUP::addItem(CoreModifiable *item, ItemPosition pos DECLARE_LINK_NAME)
{
	DWORD dwWaitResult; 
...
bool	SemaphoreWUP::removeItem(CoreModifiable* item DECLARE_LINK_NAME)
{
