	...
	namespace Collide
	{
		...
		*/
		...
		protected:
			...
			void RescursiveSearchMesh(Scene::Node3D* root, std::vector<Draw::ModernMesh*>& list);
		...
		*/
		...
		public:
			...
			static AABBTree* BuildFromMesh(Draw::ModernMesh* mesh);
		...
		protected:
			...
			Utils::DynamicGrowingBuffer<AABBTreeNode>* mDynamicGrowingBuffer = nullptr;
	...
	namespace Collide
	{
		...
		bool AABBTree::Serialize(PacketStream& stream)
		{
			...
			if (!PacketStream::IsWriting)
			{
				...
				mDynamicGrowingBuffer = new Utils::DynamicGrowingBuffer<AABBTreeNode>(aabbtreenodecount);
