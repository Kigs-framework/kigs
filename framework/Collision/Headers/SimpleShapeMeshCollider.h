...
/*
template<typename PacketStream>
bool SimpleShapeBase::Serialize(PacketStream& stream)
{
	switch (getType())
	{
	case SimpleShapeType::ST_AABBox:
		return static_cast<AABBoxSimpleShape*>(this)->Serialize(stream);
	case SimpleShapeType::ST_AACylinder:
		return static_cast<AACylinderSimpleShape*>(this)->Serialize(stream);
	case SimpleShapeType::ST_Compound:
		return static_cast<CompoundShape*>(this)->Serialize(stream);
	case SimpleShapeType::ST_AABBTree:
		return static_cast<AABBTreeShape*>(this)->Serialize(stream);
	case SimpleShapeType::ST_Transform:
		return static_cast<TransformShape*>(this)->Serialize(stream);
	}
	return false;
}*/